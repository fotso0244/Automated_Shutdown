...
export SSH_ASKPASS="/home/augentic/Windows-share/esxi-password"
...
WINDOWS_HOST1=192.168.0.124
WINDOWS_HOST1_USERNAME=Administrateur
WINDOWS_HOST1_PASSWORD=Augentic@123
echo "Shutting down Windows server with IP address $WINDOWS_HOST1 host after 10 seconds..."
bash -c "net rpc shutdown -f -t 0 -C 'Shutdown host' -U $WINDOWS_HOST1_USERNAME%$WINDOWS_HOST1_PASSWORD -I $WINDOWS_HOST1"
WAIT_TIME=60
sleep $WAIT_TIME